          ...
          <div className="up-img1 " style={{marginLeft:"2px"}}>
            ...
            <span>
              <label>
                ...
                <h3 className="uploadh2" style={{ fontFamily: "Poppins", fontStyle: "normal", fontWeight: "400", fontSize: "16px", position: "absolute", left: "10rem" }}>Upload Front Image</h3>
            ...
            <div>
              <span>
                <label>
                  ...
                  <h3 className="uploadh2" style={{ fontFamily: "Poppins", fontStyle: "normal", fontWeight: "400", fontSize: "16px", marginLeft: "3rem", marginTop: "1rem" }}>Upload Side Image</h3>
